...
public class SellerListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableView<Seller> tableViewDepartmet;
	...
	public void updateTableView() {
		// responsável por acessar o service, carregar os departamentos e jogar os
		// departamentos e jogar na ObservableList
		if (service == null) {
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		  ...
		  controller.loadAssociatedObjsects();
